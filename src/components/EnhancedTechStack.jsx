...
const EnhancedTechStack = () => {
  ...
  return (
    <section ref={sectionRef} id="tech" className="section overflow-hidden" style={{ background: 'var(--bg-secondary)', position: 'relative' }}>
      {/* Animated background (can keep scroll animation) */}
      <motion.div
        style={{
          position: 'absolute',
          top: '20%',
              ...
              {duplicatedTech.map((tech, index) => {
                ...
                return (
                  <motion.div
                    ...
                    whileHover={!isMobile ? { y: -15, scale: 1.05, rotateY: 5, transition: { duration: 0.3 } } : {}}
                    initial={isMobile ? { opacity: 1, y: 0 } : { opacity: 0, y: 50 }}
                    animate={isMobile ? { opacity: 1, y: 0 } : inView ? { opacity: 1, y: 0 } : {}}
                  ...
                  >
                    <motion.div 
                      ...
                      animate={hoveredIndex === index && !isMobile ? { 
                        rotate: [0, -10, 10, -10, 0],
                        scale: [1, 1.2, 1]
                      } : {}}
                    ...
                    <motion.div 
                      ...
                      animate={hoveredIndex === index && !isMobile ? { color: colors.glow, scale: 1.05 } : {}}
                    >
                      {tech.name}
                    </motion.div>
                  </motion.div>
            ...
            {[ 
              ...
              >
                <motion.div 
                  ...
                  animate={!isMobile ? { boxShadow: [item.glow, '0 0 10px transparent', item.glow] } : {}}
