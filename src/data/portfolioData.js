...
export const personalInfo = {
    name: "Muhammad Vikhan Muharram",
    title: "Software Engineer & System Analyst",
    tagline: "Designing efficient systems that solve real-world problems",
    email: "vikhan.muharram@example.com",
    phone: "+62 812 3456 7890",
    location: "Bandung, West Java, Indonesia",
    bio: "Hi, I'm Muhammad Vikhan Muharram, a passionate Software Engineer and System Analyst specializing in web and mobile application development. I enjoy designing efficient systems that solve real-world problems and bridge communication between technical and non-technical stakeholders.\n\nI hold a Bachelor's Degree in Software Engineering from Telkom University in Bandung, West Java (Class of 2021). My experience spans frontend, backend, and system analysis, particularly in healthcare, business, and academic environments.\n\nI've successfully contributed to developing a hospital-wide helpdesk system, mobile booking applications, and AI-based health monitoring platforms. Beyond development, I'm driven by a curiosity for how technology can improve workflows, automate communication, and empower digital transformation.",
    profileImage: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?crop=entropy&cs=srgb&fm=jpg&q=85",
    socials: {
      github: "https://github.com/vikhanmuharram",
      linkedin: "https://linkedin.com/in/vikhanmuharram",
      twitter: "https://twitter.com/vikhanmuharram",
